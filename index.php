...
if(!empty($_POST)) {
    ...
    $fromFiles = array(
						...
						'blank/app/design/adminhtml/default/default/layout/module.xml',
                        );
    ...
    $toFiles = array(
                        ...
                        'app/design/adminhtml/default/default/layout/'.$lowModule.'.xml'
                        );

    /* generatin admin module*/
	if ($_POST['generate-admin']) {
	    $fromFiles[]='blank/app/code/local/Namespace/Module/Block/Adminhtml/Module.php';
	    $toFiles[]='app/code/local/'.$capNamespace.'/'.$capModule.'/Block/Adminhtml/'.$capModule.'.php';
        $fromFiles[]='blank/app/code/local/Namespace/Module/controllers/Adminhtml/IndexController.php';
        $toFiles[]='app/code/local/'.$capNamespace.'/'.$capModule.'/controllers/Adminhtml/IndexController.php';
        $fromFiles[]='blank/app/design/adminhtml/default/default/template/module/module.phtml';
        $toFiles[]='app/design/adminhtml/default/default/template/'.$lowModule.'/'.$lowModule.'.phtml';
/*
